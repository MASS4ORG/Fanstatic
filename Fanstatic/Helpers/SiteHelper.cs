...
public static class SiteHelper
{
    ...
    public static Site Init(string configFile, IGenerateOptions options, IFrontMatterParser parser, ILogger logger,
        StopwatchReporter stopwatch, IFileSystem fs)
    {
    ...
    public static SiteSettings ParseSettings(string configFile, IGenerateOptions options, IFrontMatterParser parser,
        IFileSystem fs)
    {
        ...
        if (!fs.FileExists(filePath))
        {
            throw new FileNotFoundException(
                $"The {configFile} file was not found in the specified source directory: {options.Source}");
        }
