# Contributing to Fanstatic

Thank you for your interest in contributing to **Fanstatic**! Please take a moment to review this document **before** submitting a merge request.

Before we embark on this exciting journey, let's take a moment to appreciate the heart and soul of Fanstatic: its [GitLab repository](https://gitlab.com/fanstatic/fanstatic). The repository is a treasure trove of Fanstatic's source code, issues, and discussions. Feel free to explore, contribute, and make Fanstatic even more awesome!

We hope you're as excited as we are about the possibilities **Fanstatic** brings to the world of static site generation. Let's embark on this journey together and unleash the true potential of static websites. Happy coding and creating!
...
Please ensure that the tests are passing when submitting a merge request. If you're adding new features to **Fanstatic**, please include tests.
...
If this is something you think you can fix, then fork **Fanstatic** and create a branch with a descriptive name.
